...
class _View_SigninComponent0 extends import1.AppView<import3.SigninComponent> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this.renderer.setElementAttribute(this._el_0,'class','panel panel panel-default');
    ...
    this._text_4 = this.renderer.createText(this._el_3,'Sign In',(null as any));
    ...
    this.renderer.setElementAttribute(this._el_14,'for','email');
    this._text_15 = this.renderer.createText(this._el_14,'Mail',(null as any));
    ...
    this.renderer.setElementAttribute(this._el_17,'id','email');
    ...
    this.renderer.setElementAttribute(this._el_22,'for','password');
    ...
    this._el_28 = this.renderer.createElement(this._el_10,'button',(null as any));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import12.FormGroupDirective) && ((10 <= requestNodeIndex) && (requestNodeIndex <= 30)))) { return this._FormGroupDirective_10_3; }
    if (((token === import19.ControlContainer) && ((10 <= requestNodeIndex) && (requestNodeIndex <= 30)))) { return this._ControlContainer_10_4; }
    if (((token === import13.NgControlStatusGroup) && ((10 <= requestNodeIndex) && (requestNodeIndex <= 30)))) { return this._NgControlStatusGroup_10_5; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    if (import4.checkBinding(throwOnChange,this._expr_28,currVal_28)) {
      this.renderer.setElementProperty(this._el_28,'disabled',currVal_28);
...
export function viewFactory_SigninComponent0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.SigninComponent> {
  if ((renderType_SigninComponent === (null as any))) { (renderType_SigninComponent = viewUtils.createRenderComponentType('/home/ubuntu/workspace/fcc-app-voting/assets/app/auth/signin.component.html',0,import10.ViewEncapsulation.None,styles_SigninComponent,{})); }
